...
def paint_fig_ts(years=['2019', '2020', '2021', '2022'], province='Beijing'):
    ...
    for y in years:
        df_CB = df[
            df['Building Type'].isin(['Commercialized Buildings Sold']) & df['Date'].str.contains('|'.join(years))]
        ...
        df_HBU = df[
            df['Building Type'].isin(['Houses for Business Use Sold']) & df['Date'].str.contains('|'.join(years))]
    ...
    trace_ts_1 = go.Scatter(x=df_CB["Date"], y=df_CB["Total Sale (100 million yuan)"], name="Commercialized Buildings",
                            text=hover_text_CB, hoverinfo="text", mode="lines", marker_color='#fd7f6f')
    ...
    trace_ts_3 = go.Scatter(x=df_OB["Date"], y=df_OB["Total Sale (100 million yuan)"], name="Office Buildings",
                            mode="lines", text=hover_text_OB, hoverinfo="text", marker_color='#b2e061')
    trace_ts_4 = go.Scatter(x=df_HBU["Date"], y=df_HBU["Total Sale (100 million yuan)"], name="Houses for Business Use",
                            mode="lines", text=hover_text_HBU, hoverinfo="text", marker_color='#bd7ebe')
...
def paint_fig_fs(years=['2019', '2020', '2021', '2022'], province='Country'):
    ...
    for y in years:
        df_CB_F = df_f[
            df_f['Building Type'].isin(['Commercialized Buildings Sold']) & df_f['Date'].str.contains('|'.join(years))]
        df_CRB_F = df_f[
            df_f['Building Type'].isin(['Commercialized Residential Buildings Sold', 'Commercialized Residential']) &
            df_f['Date'].str.contains('|'.join(years))]
    ...
    trace_fs_1 = go.Bar(x=df_CB_F["Date"], y=df_CB_F["Floor Space Completed (10000 sq.m)"],
                        name="Commercialized Buildings Sold", hovertext=hover_text_CB_F, marker_color='#fd7f6f')
